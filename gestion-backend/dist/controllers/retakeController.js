...
export const getAllRetakes = async (req, res) => {
    try {
...
export const getRetakeById = async (req, res) => {
    try {
        const { id } = req.params;
...
export const createRetake = async (req, res) => {
    try {
        const data = req.body;
...
export const updateRetake = async (req, res) => {
    try {
        const { id } = req.params;
        const data = req.body;
...
export const deleteRetake = async (req, res) => {
    try {
        const { id } = req.params;
