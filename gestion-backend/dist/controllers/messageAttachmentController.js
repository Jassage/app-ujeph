...
export const getAllMessageAttachments = async (req, res) => {
    try {
...
export const getMessageAttachmentById = async (req, res) => {
    try {
        const { id } = req.params;
...
export const createMessageAttachment = async (req, res) => {
    try {
        const data = req.body;
...
export const updateMessageAttachment = async (req, res) => {
    try {
        const { id } = req.params;
        const data = req.body;
