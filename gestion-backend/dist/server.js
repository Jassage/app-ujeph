...
import { cleanupExpiredSessions, trackUserActivity, } from "./middleware/sessionTimeout";
dotenv.config();
const app = express();
...
app.use("/uploads/imports", express.static(path.join(process.cwd(), "uploads", "imports")));
