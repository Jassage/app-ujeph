...
export const getAllScholarshipDocuments = async (req: Request, res: Response) => {
  try {
...
export const getScholarshipDocumentById = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const scholarshipDocument = await prisma.scholarshipDocument.findUnique({ where: { id } });
    if (!scholarshipDocument) return res.status(404).json({ error: "ScholarshipDocument non trouvé" });
...
export const createScholarshipDocument = async (req: Request, res: Response) => {
  try {
    const data = req.body;
...
export const updateScholarshipDocument = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const data = req.body;
...
export const deleteScholarshipDocument = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
